...
import GCastleWars.Tasks.Common.BankItems.BankItems;
import GCastleWars.Tasks.Common.BankItems.CloseBank;
import GCastleWars.Tasks.Common.BankItems.GoToBank;
import GCastleWars.Tasks.Common.BankItems.OpenBank;
import GCastleWars.Tasks.Common.StayLoggedIn;
import GCastleWars.Tasks.PlayCastleWars.GetIntoGame.AcceptGameInvite;
import GCastleWars.Tasks.PlayCastleWars.GetIntoGame.GoToWaitingRoom;
import GCastleWars.Tasks.PlayCastleWars.GoToHidingSpot.GoBehindStairs;
...
public class GCastleWars extends AbstractScript {
    ...
    public void onStart() {
        ...
        currentState = Util.state("Starting GCastleWars - Gavin101...");
